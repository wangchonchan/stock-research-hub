#!/usr/bin/env python3
"""
Stock Research Engine - Ultra Robust News (Google News RSS) & Strict 20-word Summary
"""
...
class StockResearchEngine:
    ...
    def _summarize_description(self, text: str, max_words: int = 20) -> str:
    ...
    def _fetch_google_news(self):
        """Fetch news from Google News RSS as a robust source"""
        try:
        ...
        try:
            ...
            try:
                ...
                if info:
                    ...
                    self.data["description"] = self._summarize_description(raw_desc, 20)
